...
class About extends \Opencart\System\Engine\Controller {
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/sendsms/sendsms/about', 'user_token=' . $this->session->data['user_token'], true)
        );
        ...
        $this->response->setOutput($this->load->view('extension/sendsms/sendsms/about', $data));
    }
}
