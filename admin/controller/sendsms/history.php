...
class History extends \Opencart\System\Engine\Controller {
    public function index()
    {
        ...
        $history_total = $this->model_extension_sendsms_module_sendsms_history->getTotalHistory($filter_data);

        $results = $this->model_extension_sendsms_module_sendsms_history->getHistory($filter_data);
        ...
        $data['sort_status'] = $this->url->link('extension/sendsms/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=status' . $url, true);
        $data['sort_message'] = $this->url->link('extension/sendsms/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=message' . $url, true);
        $data['sort_details'] = $this->url->link('extension/sendsms/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=details' . $url, true);
        $data['sort_content'] = $this->url->link('extension/sendsms/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=content' . $url, true);
        $data['sort_type'] = $this->url->link('extension/sendsms/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=type' . $url, true);
        $data['sort_sent_on'] = $this->url->link('extension/sendsms/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=sent_on' . $url, true);
        $data['sort_phone'] = $this->url->link('extension/sendsms/sendsms/history', 'user_token=' . $this->session->data['user_token'] . '&sort=phone' . $url, true);
        ...
        $data['pagination'] = $pagination->index([
            'total' => $history_total,
            'page' => $page,
            'limit' => $this->config->get('config_pagination_admin'),
            'url' => $this->url->link('extension/sendsms/sendsms/history', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true)
        ]);
        ...
        $this->response->setOutput($this->load->view('extension/sendsms/sendsms/history', $data));
    }
}
