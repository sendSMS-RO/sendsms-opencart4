<?php
namespace Opencart\Admin\Model\Extension\Sendsms\Module\Sendsms;
...
class Orders extends \Opencart\System\Engine\Model
{
    ...
    {
        $sql = "SELECT DISTINCT o.telephone FROM " . DB_PREFIX . "order AS o, ". DB_PREFIX ."order_product AS op WHERE op.order_id = o.order_id AND o.telephone != ''";
